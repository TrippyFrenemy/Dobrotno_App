...
Revision ID: 32725b23b9d6
Revises: 040f0b9e005a
Create Date: 2025-12-06 18:58:40.534822
...
def upgrade() -> None:
    ...
    op.create_index('ix_order_order_types_order_id', 'order_order_types', ['order_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_order_order_types_order_id', table_name='order_order_types')
